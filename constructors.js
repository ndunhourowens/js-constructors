...
function Spell(name, cost, description) {
  this.name = name;  // name of spell
  this.cost = cost;  // amount need to cast spell
  this.description = description;  // description of spell
}
  ...
  Spell.prototype.printDetails = function() {
    return console.log('The spell being used is ' + this.name + '/n' +
      'The cost is ' + this.cost + '/n' +
      'The spell does ' + this.description + '/n');
   };
